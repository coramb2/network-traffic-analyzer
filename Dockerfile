...
COPY analyzer.py detector.py reporter.py network_monitor.py paths.py alert_rules.py alert_playbooks.py device_names.py notifications.py geoip.py vendor_lookup.py ./
